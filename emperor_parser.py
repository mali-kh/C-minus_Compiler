...
class Parser:
    PRODUCTIONS = {'Program': [['Declaration-list', '$']],
                   ...
                   'Var-declaration-prime': [[';', '#declare_var'], ['[', '#pnum', 'NUM', ']', ';', '#declare_array']],
                   'Fun-declaration-prime': [['(', 'Params', ')', 'Compound-stmt']],
                   'Type-specifier': [['#ptype_int', 'int'], ['#ptype_void', 'void']],
                   'Params': [['#ptype_int', 'int', '#pid', 'ID', 'Param-prime', 'Param-list'], ['void']],
                   'Param-list': [[',', 'Param', 'Param-list'], ['EPSILON']],
                   'Param': [['Declaration-initial', 'Param-prime']],
                   'Param-prime': [['[', ']', '#declare_pointer'], ['EPSILON', '#declare_var']],
                   ...
                   'B': [['=', 'Expression', '#assign'], ['[', 'Expression', ']', '#get_array_element', 'H'], ['Simple-expression-prime']],
                   'H': [['=', 'Expression', '#assign'], ['G', 'D', 'C']],
                   'Simple-expression-zegond': [['Additive-expression-zegond', 'C']],
                   'Simple-expression-prime': [['Additive-expression-prime', 'C']],
                   'C': [['Relop', 'Additive-expression', '#calculate_relation'], ['EPSILON']],
                   'Relop': [['#psmaller_than', '<'], ['#pequals', '==']],
                   'Additive-expression': [['Term', 'D']],
                   'Additive-expression-prime': [['Term-prime', 'D']],
                   'Additive-expression-zegond': [['Term-zegond', 'D']],
                   'D': [['Addop', 'Term', '#calculate_addition', 'D'], ['EPSILON']],
                   'Addop': [['#pplus', '+'], ['#pminus', '-']],
                   'Term': [['Factor', 'G']],
