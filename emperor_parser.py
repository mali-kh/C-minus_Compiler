...
class Parser:
    PRODUCTIONS = {'Program': [['Declaration-list', '$']],
                   ...
                   'Declaration-prime': [['#label', '#declare_func', '#increase_scope', 'Fun-declaration-prime'], ['Var-declaration-prime']],
                   ...
                   'Compound-stmt': [['{', 'Declaration-list', 'Statement-list', '}', '#decrease_scope']],
